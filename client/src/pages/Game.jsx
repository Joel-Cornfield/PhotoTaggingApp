    ...
    <MainContainer>
      ...
      {!gameStarted && !gameEnded &&(
        <DisplayPanelContainer>
          ...
          <GameBackgroundImage src="/assets/marvel.jpg" isBlurred={gameStarted}/>
        </DisplayPanelContainer>
      )}
      ...
      {gameEnded && (
        <DisplayPanelContainer>
          ...
          <GameBackgroundImage src="/assets/marvel.jpg" isBlurred={true}/>
        </DisplayPanelContainer>
      )}
      ...
      {gameStarted && !gameEnded &&(
        <GameContainer ref={gameContainerRef}>
          ...
          <Footer>
            <FooterTitle>Hidden Heroes</FooterTitle>
            <Description>Image created by Todd Nauck</Description>
          </Footer>
        </GameContainer>
      )}
    </MainContainer>
